...
const TITLE_WORDS = ["Download", "The", "Aleens", "App"];
const DESC_LINES = [
...
export default function MobileAppSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative z-10 flex min-h-[60vh] items-center justify-center overflow-visible bg-[#1a1a1a] px-6 py-20 sm:px-10 sm:py-24 lg:overflow-visible lg:px-16 lg:py-28 lg:pb-36"
    >
      <div className="mx-auto flex w-full max-w-[1440px] flex-col items-center gap-12 lg:flex-row lg:items-start lg:justify-between lg:gap-10">
        ...
        <div className="w-full max-w-[560px] lg:w-1/2 order-1 lg:order-2">
          ...
          >
            ...
            >
              <img
                src="/aleens/images/app-store.svg"
            ...
            >
              <img
                src="/aleens/images/play-store.svg"
