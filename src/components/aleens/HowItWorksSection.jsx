...
const STEPS = [
  {
    number: "01",
    img: "/aleens/images/how-it-work-1.png",
    lines: [
  ...
  {
    number: "02",
    img: "/aleens/images/how-it-work-2.png",
    lines: [
  ...
  {
    number: "03",
    img: "/aleens/images/how-it-work-3.png",
    lines: [
...
export default function HowItWorksSection() {
  ...
  return (
    <section
      id="how-it-works"
      ref={sectionRef}
      className="relative z-0 flex min-h-[46vh] flex-col items-center justify-center overflow-hidden bg-white px-6 py-20 pt-40 sm:px-10 sm:py-24 lg:px-16 lg:py-28 lg:pt-48"
    >
      <div className="mx-auto flex w-full max-w-[1440px] flex-col gap-12 lg:flex-row lg:items-start lg:justify-between lg:gap-10">
        ...
        <div className="w-full text-left lg:w-[32%] lg:text-left">
          ...
          >
            ...
            <a
              href="#" className="pointer-events-none whitespace-nowrap text-[11px] font-medium uppercase tracking-[0.14em] text-black transition hover:text-[#00a651]"
            >
              Call For Help →
            </a>
          </motion.div>
