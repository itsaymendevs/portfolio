      ...
      <div className="relative z-10 mx-auto flex max-w-[1440px] flex-col items-center px-6 py-28 text-center sm:px-10 sm:py-32 lg:px-16 lg:py-40">
        ...
        >
          <div className="relative flex w-full items-center">
            ...
            <button
              type="submit"
              className="absolute right-1 top-1 bottom-1 rounded-full bg-[#f7941d] px-5 text-[13px] font-medium text-white shadow hover:bg-[#e6860d] active:scale-[0.98] sm:px-6"
            >
