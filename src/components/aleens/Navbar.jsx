...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      >
        <a href="#top" className="flex items-center text-white" aria-label="Aleens home">
          <img src="/aleens/images/logo.png" alt="Aleens logo" className="h-8 w-auto sm:h-9" />
        </a>
      </motion.div>
            ...
            return (
              <motion.button
                ...
                className={`relative overflow-hidden rounded-full px-[22px] py-[10px] text-[14px] font-medium transition-colors ${
                  isActive ? "text-[#00a651]" : "text-white hover:text-white/90"
                }`}
                style={
                  isActive
                ...
                return (
                  <motion.button
                    ...
                    className={`flex w-full items-center justify-between rounded-full px-4 py-3 text-[14px] font-semibold border relative overflow-hidden ${
                      isActive ? "text-[#00a651] border-transparent" : "text-white border-transparent"
                    }`}
                    style={
                      isActive
                        ? { backgroundColor: "#E6F9EE" }
                  ...
                  >
                    ...
                    <span className="relative z-10">{label}</span>
                    <span className={`relative z-10 h-2 w-2 rounded-full ${isActive ? "bg-[#00a651]" : "bg-white"}`} />
                  </motion.button>
                );
              }
              return (
                ...
                >
                  <span>{label}</span>
                  {isActive && <span className="h-2 w-2 rounded-full bg-[#003823]" />}
                </button>
              );
            })}
          </div>
