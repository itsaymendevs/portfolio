      ...
      <div className="mx-auto flex max-w-[1440px] flex-col gap-8 lg:flex-row lg:items-center lg:justify-between lg:gap-12">
        ...
        >
          <div className="relative flex w-full items-center">
            ...
            <button
              type="submit"
              className="absolute right-1 top-1 bottom-1 rounded-full bg-[#f7941d] px-6 text-[13px] font-medium text-white shadow-[0_4px_16px_rgba(0,166,81,0.25)] transition hover:bg-[#e6860d] active:scale-[0.98] sm:px-7 sm:text-[14px]"
            >
