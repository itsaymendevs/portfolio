    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-[1440px]">
        <div className="mx-auto max-w-[720px] text-center">
          ...
          >
            <span className="h-1.5 w-1.5 rounded-full bg-[#00a651] animate-pulse" />
            Free Consultation
          </motion.div>
        ...
        >
          <label className="flex flex-1 flex-col gap-1.5 text-left">
            ...
            <div className="flex items-center gap-2 rounded-full border border-black/10 bg-white px-3 py-2.5 shadow-sm focus-within:border-[#00a651]/20 focus-within:ring-2 focus-within:ring-[#00a651]/10">
          ...
          <button
            type="submit"
            className="inline-flex h-[44px] shrink-0 items-center justify-center gap-2 rounded-full bg-[#f7941d] px-6 text-[13px] font-medium text-white shadow-[0_8px_24px_rgba(0,166,81,0.25)] transition hover:bg-[#e6860d] active:scale-[0.98] sm:h-[46px]"
          >
            {sent ? "Sent ✓" : "Confirm"}
        ...
        {sent && (
          <motion.p
            ...
            className="mx-auto mt-4 max-w-[720px] text-center text-[12px] font-medium text-[#00a651]"
          >
