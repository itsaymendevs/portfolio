...
export default function FloatingActions() {
  ...
  const [messages, setMessages] = useState([
    { id: 1, from: "ai", text: "Hi! I’m Aleens AI — tell me your goal and I’ll craft your perfect plan." },
  ]);
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="flex items-center gap-1.5 text-[13px] font-semibold leading-none">
                      Aleens AI <span className="rounded-full bg-white/15 px-1.5 py-0.5 text-[9px] font-bold tracking-[0.08em]">BETA</span>
                    </div>
