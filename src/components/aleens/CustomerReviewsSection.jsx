...
const REVIEWS = [
  {
    id: 1,
    text: "Aleens made eating clean effortless. Fresh meals daily, perfectly balanced, and the results speak for themselves. I've never felt better.",
    name: "Sarah Al Mansouri",
    job: "Fitness Coach",
    avatar: "/aleens/images/review-1.png",
    rating: 5,
    highlights: ["Aleens", "Fresh meals", "perfectly balanced"],
  },
  {
    id: 2,
    ...
    avatar: "/aleens/images/review-2.png",
    rating: 5,
  ...
  },
  {
    ...
    name: "Layla Hassan",
    job: "Yoga Instructor",
    avatar: "/aleens/images/review-3.png",
    rating: 5,
...
export default function CustomerReviewsSection() {
  ...
  return (
    <section
      ref={ref}
      className="relative w-full overflow-hidden bg-[#fcfcfa] px-6 py-20 sm:px-10 sm:py-24 lg:px-16 lg:py-28"
    >
          ...
          <div className="relative pt-16 sm:pt-20 lg:pt-28">
            ...
            <div className="mt-8 flex items-center justify-between gap-4">
                ...
                {(() => {
                  ...
                  return (
                    <>
                      ...
                      <div className="relative order-1 h-[88px] w-[140px] shrink-0 sm:order-2 sm:h-[104px] sm:w-[168px] lg:h-[112px] lg:w-[188px]">
                        <svg
                          viewBox="0 0 168 96"
              ...
              >
                ...
                <span className="hidden whitespace-nowrap text-[11px] font-medium uppercase tracking-[0.14em] text-black transition hover:text-[#00a651] min-[405px]:inline">
                  Next Review →
                </span>
                <span className="whitespace-nowrap text-[11px] font-medium uppercase tracking-[0.14em] text-black transition hover:text-[#00a651] min-[405px]:hidden">
                  Next →
                </span>
              </motion.button>
            </div>
