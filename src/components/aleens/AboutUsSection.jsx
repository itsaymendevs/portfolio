...
const LINES = [
  "Aleens started as a simple idea: eating well should feel personal, joyful and easy.",
                ...
                {parts.map((part, j) =>
                  highlights.includes(part) ? (
                    <span key={j} className="relative inline-block px-0.5">
                      <span
                        className="absolute bottom-[0.12em] left-0 right-0 h-[0.38em] rounded-[2px] bg-[#f7941d]/45"
                        aria-hidden="true"
                      />
